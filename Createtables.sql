...
if OBJECT_ID(N'dbo.ItemTransaction',N'u') is null
begin
...
ItemID int,
 ...
 CONSTRAINT [PK_CustTrans_TransactionID_ItemID] PRIMARY KEY CLUSTERED 
(
	[TransactionID] ASC,[ItemID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY],
)end
...
--********************************************************************--
ALTER TABLE [dbo].[ItemTransaction]  WITH CHECK ADD  CONSTRAINT [FK_transaction] FOREIGN KEY([TransactionID])
REFERENCES [dbo].[Transactions] ([TransactionID])
ALTER TABLE [dbo].[ItemTransaction]  WITH CHECK ADD  CONSTRAINT [FK_Item] FOREIGN KEY([ItemID])
REFERENCES [dbo].[Item] ([ItemID])
ALTER TABLE [dbo].[Customer]  WITH CHECK ADD  CONSTRAINT [FK_Customer_cart] FOREIGN KEY([CartID])
REFERENCES [dbo].[Cart] ([CartID])
ALTER TABLE [dbo].[Customer]  WITH CHECK ADD  CONSTRAINT [FK_Customer_Transaction] FOREIGN KEY([TransactionID])
REFERENCES [dbo].[Transactions] ([TransactionID])
